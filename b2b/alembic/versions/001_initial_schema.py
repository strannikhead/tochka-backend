...
def upgrade() -> None:
    ...
    op.execute("CREATE TYPE product_status AS ENUM ('CREATED', 'ON_MODERATION', 'MODERATED', 'BLOCKED', 'DELETED')")
    ...
    op.create_table(
        ...
        sa.Column('status', sa.Enum('CREATED', 'ON_MODERATION', 'MODERATED', 'BLOCKED', 'DELETED', name='product_status'), nullable=False, server_default='CREATED'),
