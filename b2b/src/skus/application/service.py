...
from b2b.src.models import SKU, ModerationOutboxEvent, OutboxStatus, Product, ProductStatus
...
class SkuService:
    ...
    async def create_sku(
        ...
        *,
        ...
        is_first_sku = (
            ...
            and not await self._has_skus(product_id)
        )
    ...
    async def _dispatch_outbox(self, event: ModerationOutboxEvent) -> None:
