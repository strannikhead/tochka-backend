...
from sqlalchemy import String, Integer, Boolean, DateTime, Text, Enum, ForeignKey, DECIMAL
...
class Product(Base):
    ...
    status: Mapped[ProductStatus] = mapped_column(Enum(ProductStatus, name="product_status"), nullable=False, default=ProductStatus.CREATED)
